...
class _ReportDetailDialogState extends State<ReportDetailDialog> {
  ...
  void initState() {
    ...
    print('Khởi tạo ReportDetailDialog cho report ID: ${widget.report.reportId}');
    print('Dữ liệu report ban đầu: ${widget.report.toJson()}');
    context.read<ReportImageBloc>().add(ResetReportImageStateEvent());
    print('Đang lấy danh sách media cho report ID: ${widget.report.reportId}');
          ...
          child: DropdownButton<String>(
            ...
            onChanged: (value) {
              if (value != null && value != (_updatedReport ?? widget.report).status) {
                print('Cập nhật trạng thái report thành: $value');
                setState(() {
